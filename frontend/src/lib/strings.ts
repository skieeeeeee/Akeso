...
export const STRINGS = {
  ...
  handoffBody: {
    en: "Your doctor scans this code and everything you answered appears on their phone. Nothing is sent over the internet.",
    hi: "आपके डॉक्टर इस कोड को स्कैन करेंगे और आपके सभी जवाब उनके फ़ोन पर आ जाएँगे। कुछ भी इंटरनेट से नहीं भेजा जाता।",
    mr: "तुमचे डॉक्टर हा कोड स्कॅन करतील आणि तुमची सर्व उत्तरे त्यांच्या फोनवर दिसतील. काहीही इंटरनेटवरून पाठवले जात नाही.",
    ta: "உங்கள் மருத்துவர் இந்தக் குறியீட்டை ஸ்கேன் செய்தால் நீங்கள் அளித்த அனைத்து பதில்களும் அவர்களின் தொலைபேசியில் தெரியும். எதுவும் இணையம் வழியாக அனுப்பப்படுவதில்லை.",
    gu: "તમારા ડૉક્ટર આ કોડ સ્કેન કરશે અને તમે આપેલા બધા જવાબ તેમના ફોન પર દેખાશે. કંઈ પણ ઇન્ટરનેટ પર મોકલાતું નથી.",
    pa: "ਤੁਹਾਡੇ ਡਾਕਟਰ ਇਹ ਕੋਡ ਸਕੈਨ ਕਰਨਗੇ ਅਤੇ ਤੁਹਾਡੇ ਸਾਰੇ ਜਵਾਬ ਉਨ੍ਹਾਂ ਦੇ ਫ਼ੋਨ ਉੱਤੇ ਆ ਜਾਣਗੇ। ਕੁਝ ਵੀ ਇੰਟਰਨੈੱਟ ਰਾਹੀਂ ਨਹੀਂ ਭੇਜਿਆ ਜਾਂਦਾ।",
  },
  handoffPrivacy: {
