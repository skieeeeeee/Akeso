...
export const STRINGS = {
  ...
  codeHint: {
    ...
    hi: "आपके मोबाइल पर भेजा गया कोड डालें",
    mr: "तुमच्या मोबाइलवर पाठवलेला कोड टाका",
    ta: "உங்கள் கைபேசிக்கு அனுப்பப்பட்ட குறியீட்டை உள்ளிடுங்கள்",
    gu: "તમારા મોબાઇલ પર મોકલેલો કોડ નાખો",
    pa: "ਤੁਹਾਡੇ ਮੋਬਾਈਲ ਉੱਤੇ ਭੇਜਿਆ ਕੋਡ ਪਾਓ",
  },
  ...
  handoffHeading: {
    en: "Show this to your doctor",
    hi: "यह अपने डॉक्टर को दिखाएँ",
    mr: "हे तुमच्या डॉक्टरांना दाखवा",
    ta: "இதை உங்கள் மருத்துவரிடம் காட்டுங்கள்",
    gu: "આ તમારા ડૉક્ટરને બતાવો",
    pa: "ਇਹ ਆਪਣੇ ਡਾਕਟਰ ਨੂੰ ਦਿਖਾਓ",
  },
  // Two codes, two different promises. The link version opens a page, which
  // needs the internet; the data version does not. Saying the wrong one would
  // be a false statement to the patient about where their record goes.
  handoffBody: {
    en: "Your doctor scans this code and your visit opens on their phone.",
    hi: "आपके डॉक्टर इस कोड को स्कैन करेंगे और आपकी मुलाक़ात उनके फ़ोन पर खुल जाएगी।",
    mr: "तुमचे डॉक्टर हा कोड स्कॅन करतील आणि तुमची भेट त्यांच्या फोनवर उघडेल.",
    ta: "உங்கள் மருத்துவர் இந்தக் குறியீட்டை ஸ்கேன் செய்தால் உங்கள் வருகை அவர்களின் தொலைபேசியில் திறக்கும்.",
    gu: "તમારા ડૉક્ટર આ કોડ સ્કેન કરશે અને તમારી મુલાકાત તેમના ફોન પર ખૂલશે.",
    pa: "ਤੁਹਾਡੇ ਡਾਕਟਰ ਇਹ ਕੋਡ ਸਕੈਨ ਕਰਨਗੇ ਅਤੇ ਤੁਹਾਡੀ ਮੁਲਾਕਾਤ ਉਨ੍ਹਾਂ ਦੇ ਫ਼ੋਨ ਉੱਤੇ ਖੁੱਲ੍ਹ ਜਾਵੇਗੀ।",
  },
  handoffBodyOffline: {
    en: "Your doctor scans this code and everything you answered appears on their phone. It works even without internet.",
    hi: "आपके डॉक्टर इस कोड को स्कैन करेंगे और आपके सभी जवाब उनके फ़ोन पर आ जाएँगे। यह इंटरनेट के बिना भी काम करता है।",
    mr: "तुमचे डॉक्टर हा कोड स्कॅन करतील आणि तुमची सर्व उत्तरे त्यांच्या फोनवर दिसतील. हे इंटरनेटशिवायही चालते.",
    ta: "உங்கள் மருத்துவர் இந்தக் குறியீட்டை ஸ்கேன் செய்தால் நீங்கள் அளித்த அனைத்து பதில்களும் அவர்களின் தொலைபேசியில் தெரியும். இணையம் இல்லாமலும் இது வேலை செய்யும்.",
    gu: "તમારા ડૉક્ટર આ કોડ સ્કેન કરશે અને તમે આપેલા બધા જવાબ તેમના ફોન પર દેખાશે. ઇન્ટરનેટ વગર પણ કામ કરે છે.",
    pa: "ਤੁਹਾਡੇ ਡਾਕਟਰ ਇਹ ਕੋਡ ਸਕੈਨ ਕਰਨਗੇ ਅਤੇ ਤੁਹਾਡੇ ਸਾਰੇ ਜਵਾਬ ਉਨ੍ਹਾਂ ਦੇ ਫ਼ੋਨ ਉੱਤੇ ਆ ਜਾਣਗੇ। ਇਹ ਇੰਟਰਨੈੱਟ ਤੋਂ ਬਿਨਾਂ ਵੀ ਕੰਮ ਕਰਦਾ ਹੈ।",
  },
  handoffPrivacy: {
    en: "Only show this code to your doctor. Anyone who photographs it can read your answers.",
    hi: "यह कोड केवल अपने डॉक्टर को दिखाएँ। जो कोई इसकी तस्वीर लेगा, वह आपके जवाब पढ़ सकता है।",
    mr: "हा कोड केवळ तुमच्या डॉक्टरांनाच दाखवा. जो कोणी याचा फोटो घेईल, तो तुमची उत्तरे वाचू शकतो.",
    ta: "இந்தக் குறியீட்டை உங்கள் மருத்துவரிடம் மட்டுமே காட்டுங்கள். இதைப் புகைப்படம் எடுப்பவர் உங்கள் பதில்களைப் படிக்க முடியும்.",
    gu: "આ કોડ ફક્ત તમારા ડૉક્ટરને બતાવો. જે કોઈ તેનો ફોટો લેશે તે તમારા જવાબ વાંચી શકે છે.",
    pa: "ਇਹ ਕੋਡ ਸਿਰਫ਼ ਆਪਣੇ ਡਾਕਟਰ ਨੂੰ ਦਿਖਾਓ। ਜੋ ਕੋਈ ਇਸਦੀ ਫ਼ੋਟੋ ਲਵੇਗਾ, ਉਹ ਤੁਹਾਡੇ ਜਵਾਬ ਪੜ੍ਹ ਸਕਦਾ ਹੈ।",
  },
  handoffOfflineNote: {
    en: "This code holds your visit inside it, so it works without internet.",
    hi: "इस कोड में आपकी मुलाक़ात मौजूद है, इसलिए यह इंटरनेट के बिना भी काम करता है।",
    mr: "या कोडमध्ये तुमची भेट आहे, म्हणून तो इंटरनेटशिवाय चालतो.",
    ta: "இந்தக் குறியீட்டிற்குள் உங்கள் வருகை உள்ளது, எனவே இணையம் இல்லாமல் வேலை செய்யும்.",
    gu: "આ કોડમાં તમારી મુલાકાત સમાયેલી છે, તેથી ઇન્ટરનેટ વગર ચાલે છે.",
    pa: "ਇਸ ਕੋਡ ਵਿੱਚ ਤੁਹਾਡੀ ਮੁਲਾਕਾਤ ਮੌਜੂਦ ਹੈ, ਇਸ ਲਈ ਇਹ ਇੰਟਰਨੈੱਟ ਤੋਂ ਬਿਨਾਂ ਚੱਲਦਾ ਹੈ।",
  },
  handoffEnlarge: {
    en: "Make it bigger",
    hi: "बड़ा करें",
  ...
  handoffCodeAlt: {
    en: "QR code containing your visit answers",
    hi: "आपकी मुलाक़ात के जवाबों वाला QR कोड",
    mr: "तुमच्या भेटीच्या उत्तरांचा QR कोड",
    ta: "உங்கள் வருகைப் பதில்களைக் கொண்ட QR குறியீடு",
    gu: "તમારા મુલાકાતના જવાબો ધરાવતો QR કોડ",
    pa: "ਤੁਹਾਡੀ ਮੁਲਾਕਾਤ ਦੇ ਜਵਾਬਾਂ ਵਾਲਾ QR ਕੋਡ",
  },
  handoffFailedTitle: {
    en: "The code could not be made",
    hi: "कोड नहीं बन सका",
    mr: "कोड तयार होऊ शकला नाही",
    ta: "குறியீட்டை உருவாக்க முடியவில்லை",
    gu: "કોડ બની શક્યો નહીં",
    pa: "ਕੋਡ ਨਹੀਂ ਬਣ ਸਕਿਆ",
  },
  handoffFailedBody: {
    en: "Your answers are saved. Please tell the front desk so your doctor can open them directly.",
    hi: "आपके जवाब सुरक्षित हैं। कृपया रिसेप्शन को बताएँ ताकि डॉक्टर उन्हें सीधे देख सकें।",
    mr: "तुमची उत्तरे जतन झाली आहेत. कृपया रिसेप्शनला सांगा जेणेकरून डॉक्टर ती थेट पाहू शकतील.",
    ta: "உங்கள் பதில்கள் சேமிக்கப்பட்டுள்ளன. மருத்துவர் அவற்றை நேரடியாகப் பார்க்க வரவேற்பு மேசையில் தெரிவிக்கவும்.",
    gu: "તમારા જવાબ સાચવાયેલા છે. કૃપા કરીને રિસેપ્શનને જણાવો જેથી ડૉક્ટર તે સીધા જોઈ શકે.",
    pa: "ਤੁਹਾਡੇ ਜਵਾਬ ਸੰਭਾਲੇ ਗਏ ਹਨ। ਕਿਰਪਾ ਕਰਕੇ ਰਿਸੈਪਸ਼ਨ ਨੂੰ ਦੱਸੋ ਤਾਂ ਜੋ ਡਾਕਟਰ ਉਹ ਸਿੱਧੇ ਦੇਖ ਸਕਣ।",
  },
